...
/flux-ilias-ilias-base/bin/download-archive.sh "https://github.com/fluxfw/flux-ilias-rest-api/releases/download/$tag/flux-ilias-rest-api-$tag-build.tar.gz" "$ILIAS_WEB_DIR/Customizing/global/flux-ilias-rest-api"
